...
export default function Login() {
  return (
    <div className="text-[#D1D5DA] container mx-auto pt-10 px-4">
      ...
      <p className="mb-6">
        This commercial service app and is intended for use as is.
      </p>
      <p className="mb-6">
      ...
      <p className="mb-6">
        If you choose to use Service, then you agree to the collection and use
      ...
      <p className="mb-6">
        ...
        Terms and Conditions, which are accessible at T-App unless otherwise
        defined in this Privacy Policy.
      </p>

      <h2 className="text-xl mb-6 font-bold">Information Collection and Use</h2>
      ...
      <h2 className="text-xl mb-6 font-bold">Log Data</h2>

      <p className="mb-6">
        I want to inform you that whenever you use this Service, in a case of an
      ...
      <h2 className="text-xl mb-6 font-bold">Cookies</h2>
      ...
      <h2 className="text-xl mb-6 font-bold">Service Providers</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl mb-6 font-bold">Security</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl mb-6 font-bold">Links to Other Sites</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl mb-6 font-bold">Children’s Privacy</h2>
      <p className="mb-6">
      ...
      <h2 className="text-xl mb-6 font-bold">Changes to This Privacy Policy</h2>
      <p className="mb-6">
      ...
      <p className="mb-6">This policy is effective as of 2023-03-20</p>

      <h2 className="text-xl mb-6 font-bold">Contact Us</h2>
      <p className="mb-6">
